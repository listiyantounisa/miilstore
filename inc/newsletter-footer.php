...
<div class="footer-top">
	<div class="container">
		<div class="col-lg-3 footer-grid">
			...
			Suspendisse sed accumsan risus. Curabitur rhoncus, elit vel tincidunt elementum, nunc urna tristique nisi, in interdum libero magna tristique ante. 
			Adipiscing varius. Vestibulum dolor lorem.</p>
		</div>
		<div class="col-lg-3 footer-grid">
			<h3>Menu</h3>
		...
		<div class="col-lg-3 footer-grid">
			...
			<div class="contact-grid">
				...
				<div class="contact1">
					<h3>Alamat Pusat</h3>
					<p>Jl. Raya Condet Jakarta Timur</p>
				</div>
...
<!-- ScrollTop -->
<a href="#" class="scrollup hidden-xs"></a>